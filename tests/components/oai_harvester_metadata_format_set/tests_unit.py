...
class TestOaiHarvesterMetadataFormatSetGetByMetadataAndSet(TestCase):
    ...
    def test_get_by_metadata_format_and_set_return_object(self, get_by_metadata_format_and_set):
        # Arrange
        mock_oai_harvester_metadata_format_set = _create_mock_oai_harvester_metadata_format_set()

        get_by_metadata_format_and_set.return_value = mock_oai_harvester_metadata_format_set

        # Act
        result = harvester_metadata_format_set_api.\
            get_by_metadata_format_and_set(mock_oai_harvester_metadata_format_set.harvester_metadata_format,
    ...
    @patch.object(OaiHarvesterMetadataFormatSet, 'get_by_metadata_format_and_set')
    def test_get_by_metadata_format_and_set_raises_exception_if_object_does_not_exist(self,
        ...
        with self.assertRaises(exceptions.DoesNotExist):
            harvester_metadata_format_set_api.get_by_metadata_format_and_set(mock_absent_metadata_format,
                                                                             mock_absent_set)

    @patch.object(OaiHarvesterMetadataFormatSet, 'get_by_metadata_format_and_set')
    def test_get_by_metadata_format_and_set_raises_exception_if_internal_error(self, get_by_metadata_format_and_set):
        # Arrange
        mock_absent_metadata_format = ObjectId()
        mock_absent_set = ObjectId()
...
class TestOaiHarvestMetadataFormatSetUpsert(TestCase):
    ...
    def test_upsert_oai_harvester_metadata_format_set_raises_exception_if_save_failed(self, mock_save):
        # Arrange
        mock_save.side_effect = Exception()

        # Act + Assert
        with self.assertRaises(Exception):
            harvester_metadata_format_set_api.upsert(self.oai_harvester_metadata_format_set)
    ...
    def test_upsert_oai_harvester_metadata_format_set_return_object(self, mock_create):
        ...
        # Act
        result = harvester_metadata_format_set_api.upsert(self.oai_harvester_metadata_format_set)

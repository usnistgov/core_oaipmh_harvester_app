...
class TestOaiHarvesterMetadataFormatGetById(TestCase):
    @patch('core_oaipmh_harvester_app.components.oai_harvester_metadata_format.models.OaiHarvesterMetadataFormat.'
           'get_by_id')
...
class TestOaiHarvesterMetadataFormatGetByMetadataPrefixAndRegistryId(TestCase):
    ...
    def test_get_by_metadata_prefix_and_registry_id_return_object(self, mock_get):
        ...
        result = harvester_metadata_format_api.\
            get_by_metadata_prefix_and_registry_id(mock_oai_harvester_metadata_format.metadataPrefix,
                                                   mock_oai_harvester_metadata_format.registry_id)
    ...
    @patch('core_oaipmh_harvester_app.components.oai_harvester_metadata_format.models.OaiHarvesterMetadataFormat.'
           'get_by_metadata_prefix_and_registry_id')
    def test_get_by_metadata_prefix_and_registry_id_throws_exception_if_object_does_not_exist(self, mock_get):
        # Arrange
...
class TestOaiHarvesterMetadataFormatGetAllByRegistryId(TestCase):
    ...
    def test_get_all_contains_only_oai_harvester_metadata_format(self, mock_get_all_by_registry_id):
        ...
        # Act
        result = harvester_metadata_format_api.get_all_by_registry_id(mock_oai_harvester_metadata_format1.registry_id)
    ...
    @patch('core_oaipmh_harvester_app.components.oai_harvester_metadata_format.models.OaiHarvesterMetadataFormat.'
           'get_all_by_registry_id')
    def test_get_all_oai_harvester_metadata_format_throws_exception_if_object_does_not_exist(self, mock_get_all):
        # Arrange
        mock_absent_registry = str(ObjectId())
        ...
        # Act + Assert
        with self.assertRaises(exceptions.ApiError):
            harvester_metadata_format_api.get_all_by_registry_id(mock_absent_registry)


class TestOaiHarvesterMetadataFormatGetAllToHarvestByRegistryId(TestCase):
    @patch('core_oaipmh_harvester_app.components.oai_harvester_metadata_format.models.OaiHarvesterMetadataFormat.'
           'get_all_by_registry_id_and_harvest')
    def test_get_all_contains_only_oai_harvester_metadata_format_to_harvest_by_registry_id(self, mock_get_all):
        ...
        # Act
        result = harvester_metadata_format_api.\
            get_all_to_harvest_by_registry_id(mock_oai_harvester_metadata_format1.registry_id)
    ...
    @patch('core_oaipmh_harvester_app.components.oai_harvester_metadata_format.models.OaiHarvesterMetadataFormat.'
           'get_all_by_registry_id_and_harvest')
    def test_get_all_oai_harvester_metadata_format_to_harvest_by_registry_id_throws_exception_if_object_does_not_exist(
                                                                                                        self,
                                                                                                        mock_get_all):
        # Arrange
        mock_absent_registry = str(ObjectId())
        ...
        # Act + Assert
        with self.assertRaises(exceptions.ApiError):
            harvester_metadata_format_api.get_all_to_harvest_by_registry_id(mock_absent_registry)
...
class TestOaiHarvestMetadataFormatUpsert(TestCase):
    ...
    @patch('core_oaipmh_harvester_app.components.oai_harvester_metadata_format.models.OaiHarvesterMetadataFormat.save')
    ...
    @patch(
        'core_oaipmh_harvester_app.components.oai_harvester_metadata_format.models.OaiHarvesterMetadataFormat.save')
    def test_upsert_oai_harvester_metadata_format_with_raw_return_object(self, mock_create):
        # Arrange
    ...
    @patch(
        'core_oaipmh_harvester_app.components.oai_harvester_metadata_format.models.OaiHarvesterMetadataFormat.save')
    def test_upsert_oai_harvester_metadata_format_without_raw_return_object(self, mock_create):
        # Arrange
    ...
    @patch(
        'core_oaipmh_harvester_app.components.oai_harvester_metadata_format.models.OaiHarvesterMetadataFormat.save')
    def test_upsert_oai_harvester_metadata_format_invalid_raw_return_object(self, mock_create):
        # Arrange
    ...
    @patch(
        'core_oaipmh_harvester_app.components.oai_harvester_metadata_format.models.OaiHarvesterMetadataFormat.save')
    def test_upsert_oai_harvester_metadata_format_invalid_raw_return_empty_raw(self, mock_create):
        # Arrange
        self.oai_harvester_metadata_format.raw = '<root?</root>'
    ...
    @patch(
        'core_oaipmh_harvester_app.components.oai_harvester_metadata_format.models.OaiHarvesterMetadataFormat.save')
    def test_upsert_oai_harvester_metadata_format_no_exception_if_raw_not_string(self, mock_create):
        # Arrange
...
class TestOaiHarvesterMetadataFormatDeleteAllByRegistryId(TestCase):
    @patch('core_oaipmh_harvester_app.components.oai_harvester_metadata_format.models.OaiHarvesterMetadataFormat.'
           'delete_all_by_registry_id')
    def test_delete_all_by_registry_id_throws_exception_if_object_does_not_exist(self, mock_delete_all):
        # Arrange
        mock_absent_registry = str(ObjectId())
...
class TestOaiHarvesterMetadataFormatDelete(TestCase):
    @patch('core_oaipmh_harvester_app.components.oai_harvester_metadata_format.models.OaiHarvesterMetadataFormat.'
           'delete')
    def test_delete_oai_harvester_metadata_format_throws_exception_if_object_does_not_exist(self, mock_delete):
        # Arrange
...
class TestOaiHarvesterMetadataFormatUpdateForAllByRegistryId(TestCase):
    @patch('core_oaipmh_harvester_app.components.oai_harvester_metadata_format.models.OaiHarvesterMetadataFormat.'
           'update_for_all_harvest_by_registry_id')
    def test_update_for_all_harvest_by_registry_id_throws_exception_if_object_does_not_exist(self, mock_update_all):
        # Arrange
        mock_absent_registry = str(ObjectId())
...
def _create_oai_harvester_metadata_format():
    """
    Get an OaiHarvestMetadataFormat object
    :return:
    """
...
def _create_mock_oai_harvester_metadata_format():
    """
    Mock an OaiHarvestMetadataFormat object
    :return:
    """
...
def _set_oai_harvester_metadata_format_fields(oai_harvester_metadata_format):
    """
    Set OaiHarvestMetadataFormat fields
    :return:
    """
    ...
    oai_harvester_metadata_format.raw = '<metadataFormat xmlns="http://test.com" '\
                                        'xmlns:xsi="http://test.com/meta">'\
                                        '<metadataNamespace>http://test.com</metadataNamespace>'\
                                        '<metadataPrefix>test</metadataPrefix>'\
                                        '<schema>http://test.com/test.xsd</schema></metadataFormat>'
    oai_harvester_metadata_format.template = ObjectId()
    oai_harvester_metadata_format.registry_id = str(ObjectId())

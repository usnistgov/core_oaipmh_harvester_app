...
def get_by_id(oai_harvester_set_id):
    ...
    try:
        ...
        raise MDCSError('No OaiHarvesterSet could be found with the given id')
...
def get_by_set_spec_and_registry(set_spec, registry):
    ...
    try:
        ...
        raise MDCSError('No OaiHarvesterSet could be found with the given setSpec and registry')
...
def get_all_by_registry(registry, order_by_field=None):
    ...
    try:
        ...
        raise MDCSError('No OaiHarvesterSet could be found with the given registry.')

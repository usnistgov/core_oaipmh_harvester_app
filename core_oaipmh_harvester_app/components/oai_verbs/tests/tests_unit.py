...
#     def test_list_metadata_formats_as_object_return_object_and_ok_status(self, mock_identify, mock_transform):
#         # Arrange
#         mock_identify.return_value = [], status.HTTP_200_OK
...
#     def test_list_sets_as_object_return_object_and_ok_status(self, mock_identify, mock_transform):
#         # Arrange
#         mock_identify.return_value = [], status.HTTP_200_OK
